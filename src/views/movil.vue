<template>
  <div class="estructura">
    <FrontPage
      titulo_portada_frontpage="Hola"
      parrafo_front_page="esto es un parrafo "
      texto_boton_portada_front="Iniciemos"
      url_img_front_page="../../public/Mockup MobileSite UI design.png"
    ></FrontPage>
